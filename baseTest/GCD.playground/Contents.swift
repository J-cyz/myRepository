...
//http://www.jianshu.com/p/608979ac2151
//http://www.jianshu.com/p/f364bf37d62f
...
var value = 10
let workItem = DispatchWorkItem {   //代码块
    value += 5
}
workItem.perform()      //执行方法1

queue.async(execute: workItem)  //执行方法2

//workItem执行完成后并未跳转至主线程
